...
namespace Sample.AudioVideoPlaybackBot.FrontEnd
{
    ...
    internal static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            IDictionary<string, VideoFormat> H264FileLocations = new Dictionary<string, VideoFormat>();
            H264FileLocations = new Dictionary<string, VideoFormat>();
            H264FileLocations.Add("output720p.264", VideoFormat.H264_1280x720_30Fps);
            H264FileLocations.Add("output180p.264", VideoFormat.H264_320x180_15Fps);
            H264FileLocations.Add("output360p.264", VideoFormat.H264_640x360_30Fps);
            H264FileLocations.Add("mle1080p15vbss_2500Kbps.264", VideoFormat.H264_1920x1080_15Fps);
        ...
        public static List<AudioMediaBuffer> CreateAudioMediaBuffers(long currentTick, bool replayed, IGraphLogger logger)
        {
            ...
            using (FileStream fs = File.Open("downsampled.wav", FileMode.Open))
            {
